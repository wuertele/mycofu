...
run_steps() {
  ...
  (
    ...
    # Sprint 039: vm-scope.sh reads VM_SCOPE_APPS_CONFIG (its own env var,
    # not APPS_CONFIG). Without this, vm-scope.sh would read the real
    # applications.yaml and miss this fixture's `workstation` app.
    export VM_SCOPE_APPS_CONFIG="${repo_dir}/site/applications.yaml"
