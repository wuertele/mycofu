...
# synthetic ${FIXTURE_REPO}/operator.age.key. Hermetic tests must not
# depend on any real-VM secret path being present outside the fixture.
...
# install-pbs.sh / configure-pbs.sh are deliberately NOT nooped here — this
# fixture asserts their real ordering. See tests/lib/rebuild_fixture_helpers.sh.
