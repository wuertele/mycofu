...
# in the build stage where it can share /nix/store with build:image:
# [hil-boot]. The validate-stage iso-contract test now keeps only the
# fast eval/static checks.
