...
setup_validator_fixture_repo() {
  ...
  cp "${REPO_ROOT}/framework/scripts/list-replicated-vmids.sh" "${repo_dir}/framework/scripts/list-replicated-vmids.sh"
  chmod +x "${repo_dir}/framework/scripts/list-replicated-vmids.sh"
