...
|----|------|-------------|----------|--------|-----------|
| DRT-001 | Warm Rebuild | INVALIDATED | 2026-05-01 | pending Sprint 035 rerun (CI changes) | ~45 min |
| DRT-002 | Cold Rebuild | INVALIDATED | 2026-04-03 | pending Sprint 035 rerun (config template change) | ~50 min |
| DRT-003 | PBS Restore | VALID | 2026-05-01 | Sprint 035 no longer invalidates after scope reduction | ~6 min |
...
**Status:** INVALIDATED by Sprint 034; last PASS was 2026-05-01 commit
`a41fb69` (Sprint 033 closure rerun) covering Sprint 033
publish:github machinery (`.gitlab-ci.yml`,
...
**Status:** INVALIDATED by Sprint 034; last PASS was 2026-05-01 commit
`a41fb69` (Sprint 033 closure rerun) covering Sprint 033 changes to
`.gitlab-ci.yml` and `validate.sh` (the
