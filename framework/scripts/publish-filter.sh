...
publish_filter_path_allowed() {
  ...
  case "$rel_path" in
    docs/prompts|docs/prompts/*|docs/reports|docs/reports/*|docs/research|docs/research/*|docs/forensics|docs/forensics/*|docs/sprints|docs/sprints/*|tests/hil|tests/hil/*)
      return 1
      ;;
  esac
