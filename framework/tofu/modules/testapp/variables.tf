...
variable "image" {
  description = "Proxmox file ID for the testapp image"
  type        = string
}
...
variable "vault_approle_role_id" {
  description = "Vault AppRole role_id for cert storage access"
  type        = string
  default     = ""
  sensitive   = true
}
...
variable "vault_approle_secret_id" {
  description = "Vault AppRole secret_id for cert storage access"
  type        = string
  default     = ""
  sensitive   = true
}
