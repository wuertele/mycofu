...
variable "replication_policy_on" {
  description = "See framework/tofu/modules/proxmox-vm/variables.tf — Sprint 047 #691 interim HA-retry damage limiter. Default null = zero plan diff on this vendor-appliance HA resource."
  type        = bool
  default     = null
}
