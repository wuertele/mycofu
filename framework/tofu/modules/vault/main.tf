...
module "vault" {
  # Trade-off: keep Vault on the base VM module in Sprint 022. Switching this
  # wrapper to proxmox-vm-precious changes destroy/apply semantics and DR
  # expectations, so that lifecycle-class change belongs in a separate review.
  source = "../proxmox-vm"
